...
public class QuestionController {
    ...
    public ResponseEntity<Page<QuestionDTO>> getAllQuestionsPaging(@RequestParam(defaultValue = "0") int page,
                                                               @RequestParam(defaultValue = "3") int size) {
        Pageable paging = PageRequest.of(page, size);
        Page<QuestionDTO> questionPage = questionService.getAllQuestionsPaging(paging);
